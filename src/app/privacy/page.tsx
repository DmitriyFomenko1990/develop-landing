  ...
  return (
    <main className="page-wrap max-w-2xl py-20">
      ...
      <div className="mt-8 space-y-4 text-[16px] leading-[1.55] text-muted">
        ...
        <p>
          Форма собирает имя, контакт, текст и ответы, какой проект нужен,
          чтобы ответить на заявку. Данные не продаём и не используем для
          рассылок.
        </p>
        <p>
          Заявка уходит оператору в Telegram и на почту.
        </p>
        <p>
          Если вы принимаете cookie, включаем Яндекс Метрику, чтобы видеть, как
          пользуются сайтом. Отклонить можно в баннере. Это не влияет на заявку.
        </p>
      </div>
    </main>
  );
